...
public class HrManagementSystem {
    ...
    public static void main(String[] args) {
        HrManagementSystem projectInstance = new HrManagementSystem();

        // Create a SalesRep and a SalesManager
        SalesRep rep1 = projectInstance.new SalesRep("anjali", "y", 3037, 22, 200, 5, 35000, 2, 100000);
        SalesManager manager = projectInstance.new SalesManager("manasa", "y", 5059, 22, 100, 50, 50000, 5);

        // Add SalesRep to the team
        manager.addToTeam(rep1);

        // Display information for SalesRep (anjali)
        System.out.println("anjali's time to retirement: " + rep1.timeToRetirement());
        System.out.println("anjali's vacation time left: " + rep1.vacationTimeLeft());
        System.out.println("anjali's bonus: " + rep1.calculateBonus());
        System.out.println("anjali's commission: " + rep1.calculateCommission());

        // Display information for SalesManager (manasa)
        System.out.println("manasa's time to retirement: " + manager.timeToRetirement());
        System.out.println("manasa's vacation time left: " + manager.vacationTimeLeft());
        System.out.println("manasa's bonus: " + manager.calculateBonus());
